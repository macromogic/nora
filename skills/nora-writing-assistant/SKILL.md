...
This skill is primarily skill-driven rather than CLI-driven: the CLI only scaffolds and checks `.nora/writing/*` (`nora writing init` / `nora writing doctor`); all actual writing work happens through these workflows.
